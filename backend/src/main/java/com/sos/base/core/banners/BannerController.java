...
public class BannerController {
    ...
    public ResponseEntity<List<BannerDto>> create(@Valid @RequestParam("files") List<MultipartFile> files,
            @RequestParam("bannerCategoryId") String categoryId) throws Exception {
        
        CreateBannerRequest createBannerRequest = new CreateBannerRequest(categoryId, files);
