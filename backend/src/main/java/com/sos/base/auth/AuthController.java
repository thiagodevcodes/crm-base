...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> login(
        ...
        LoginResponse dto = new LoginResponse(
                login.accessToken(), login.cookie(), login.expiresIn(), login.username(), login.name(), login.roles(),
                login.permissions());
    ...
    public ResponseEntity<GetMeResponse> me(@CookieValue(name = "token", required = false) String token,
            HttpServletResponse response) {
